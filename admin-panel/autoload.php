        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php //----------REWARDS ?>
                    <?php if ($is_admin == true) { ?>
                        <li <?php echo ($page == 'manage-rewards') ? 'class="active"' : ''; ?>>
                            <a href="javascript:void(0);" class="menu-toggle">
                                <i class="material-icons">paid</i>
                                <span>Rewards</span>
                            </a>
                            <ul class="ml-menu">
                                <li <?php echo ($page == 'rewards-settings') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('rewards-settings'); ?>">Settings</a>
                                </li>
                                <li <?php echo ($page == 'rewards-requests') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo Wo_LoadAdminLinkSettings('rewards-requests'); ?>">Requests</a>
                                </li>
                            </ul>
                        </li>
                    <?php } ?>
