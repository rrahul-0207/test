...
function Wo_IsFollowing($following_id, $user_id = 0, $session_id = 0) {
    global $sqlConnect, $wo;
    if (empty($session_id)) {
        if ($wo['loggedin'] == false) {
           return false;
    ...
    if ((empty($user_id) || !is_numeric($user_id) || $user_id < 0) && empty($session_id)) {
...
function Wo_RegisterFollow($following_id = 0, $follower_id = 0, $session_id = 0) {
    global $wo, $sqlConnect;
    if (empty($session_id)) {
        if ($wo['loggedin'] == false) {
           return false;
    ...
    $active       = 1;
    if (Wo_IsFollowing($following_id, $follower_id, $session_id) === true) {
        return false;
    }
...
function Wo_IsFollowRequested($following_id = 0, $follower_id = 0, $session_id = 0) {
    global $sqlConnect, $wo;
    if (empty($session_id)) {
        if ($wo['loggedin'] == false) {
           return false;
    ...
    if ((!isset($follower_id) or empty($follower_id) or !is_numeric($follower_id) or $follower_id < 1) AND empty($session_id)) {
...
function Wo_DeleteFollow($following_id = 0, $follower_id = 0, $session_id = 0) {
    global $wo, $sqlConnect;
    if (empty($session_id)) {
        if ($wo['loggedin'] == false) {
           return false;
    ...
    $following_id = Wo_Secure($following_id);
    $follower_id  = Wo_Secure($follower_id);
    if (Wo_IsFollowing($following_id, $follower_id, $session_id) === false && Wo_IsFollowRequested($following_id, $follower_id, $session_id) === false) {
        return false;
    } else {
...
function Wo_DeleteConversation($user_id = 0, $deleter_id = 0) {
    global $wo, $sqlConnect;
    if (empty($deleter_id)) {
        if ($wo['loggedin'] == false) {
           return false;
