                    ...
                    if (!empty($_POST['type'])) {
                        if ($_POST['type'] == 'general_settings') {
                            ...
                            if (empty($errors)) {
                                ...
                                $update_user_data = Wo_UpdateAPPUserData($user_id, $u_user_data);
                                if ($update_user_data) {
                                    $updated = true;
                                }
                            }
                            ...
                            if (empty($errors)) {
                                ...
                                $update_user_data = Wo_UpdateAPPUserData($user_id, $password_data);
                                if ($update_user_data) {
                                    $updated = true;
                            ...
                            if (empty($errors)) {
                                ...
                                $update_user_data = Wo_UpdateAPPUserData($user_id, $Update_data);
                                if ($update_user_data) {
                                    $updated = true;
                                }
                            }
                            ...
                            $user_data = $json_decode;
                            if (empty($errors)) {
                                $update_user_data = Wo_UpdateAPPUserData($user_id, $user_data);
                                if ($update_user_data) {
                                    $updated = true;
                                }
                            }
